...
export function Button({
    ...
    const variants = {
        primary: 'bg-accent text-background hover:bg-accent-hover shadow-glow hover:shadow-lg',
        secondary: 'bg-background-tertiary text-text-primary border border-card-border hover:bg-card-hover',
